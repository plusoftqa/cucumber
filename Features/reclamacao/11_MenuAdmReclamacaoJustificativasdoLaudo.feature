...
@tag
Feature: Menu Administrativo Reclamacao > Justificativas do laudo
  @Acesso_sistema
  Scenario: Logar acessar Modulo Administrativo
   ...
   Scenario: Incluir registro completo 
    ...
    And Acessar sub-menu "Justificativas do laudo"
    And Clicar botao "Novo"
    Given Digitar Justificativa do laudo "01AQAJUSTLAUDO"
 ...
 @Incluir
  ...
  And Clicar botao "Novo"
  Given Digitar Justificativa do laudo "02AQAJUSTLAUDO"
  ...
  @Incluir
  Scenario: Incluir 
  Given Digitar Justificativa do laudo "03AQAJUSTLAUDO"
  ...
  Given Digitar Justificativa do laudo "04AQAJUSTLAUDO"
  And Clicar botao "Salvar"
  And Validar Alert de Sucesso
  ...
  Given Digitar Justificativa do laudo "05AQAJUSTLAUDO"
  And Clicar botao "Salvar"
  And Validar Alert de Sucesso

...
@tag
Feature: Menu Administrativo Força de Vendas > Concorrente
  ...
  Scenario: Incluir registro completo
    ...
    And Acessar sub-menu "Concorrentes"
    And Clicar botao "Novo"
    And Digitar Concorrente "01AQACONCORRENTE"
  ...
  Scenario: Incluir e inativar
    And Clicar botao "Novo"
    And Digitar Concorrente "02AQACONCORRENTE"
    And Digitar Pontuacao "01"
  ...
  @Incluir
  Scenario: Incluir
    And Digitar Concorrente "03AQACONCORRENTE"
    And Digitar Pontuacao "01"
    And Clicar botao "Salvar"
    And Validar Alert de Sucesso
  ...
  Scenario: Editar registro
    ...
    And Digitar Concorrente "04AQACONCORRENTE"
    And Digitar Pontuacao "01"
    And Clicar botao "Salvar"
    And Validar Alert de Sucesso
  ...
  Scenario: Duplicar Registro
    ...
    And Digitar Concorrente "05AQACONCORRENTE"
    And Digitar Pontuacao "01"
    And Clicar botao "Salvar"
    And Validar Alert de Sucesso
